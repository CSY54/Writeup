# [Cryptography] [basics] crypto - (50 pts)
...
The file contains the binary value of the ASCII characters.
By converting it back into ASCII, we get
...
The second line is base64 encoded.
...
Substitute the cipher back using the character map:
```txt
abcdefghijklmnopqrstuvwxyz
iphuasdyjfromxwbcnktvqlegz
```
